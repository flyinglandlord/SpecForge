...
class Model(nn.Module):
    ...
    def topK_genrate(self, hidden_states, input_ids, head, logits_processor, unk_head_softmax=False):
        ...
        ss_logits_list = torch.cat(ss_logits_list, dim=0).view(-1, self.config.draft_vocab_size)
        ...
        return draft_tokens, retrieve_indices, tree_mask, tree_position_ids, ss_logits_list
